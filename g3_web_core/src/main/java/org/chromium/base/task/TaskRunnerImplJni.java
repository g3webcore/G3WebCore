...
final class TaskRunnerImplJni implements TaskRunnerImpl.Natives {
  ...
  public long init(int taskRunnerType, boolean prioritySetExplicitly, int priority,
    ...
    return (long)GEN_JNI.org_chromium_base_task_TaskRunnerImpl_init(taskRunnerType, prioritySetExplicitly, priority, mayBlock, useThreadPool, extensionId, extensionData);
  }
