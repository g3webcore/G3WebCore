...
public final class PaymentErrorReason {
    ...
    public static final int USER_CANCEL = 1; // UNKNOWN + 1
    public static final int NOT_SUPPORTED = 2; // USER_CANCEL + 1
    public static final int ALREADY_SHOWING = 3; // NOT_SUPPORTED + 1
