...
public final class ShareError {
    ...
    public static final int INTERNAL_ERROR = 1; // OK + 1
    public static final int PERMISSION_DENIED = 2; // INTERNAL_ERROR + 1
    public static final int CANCELED = 3; // PERMISSION_DENIED + 1
