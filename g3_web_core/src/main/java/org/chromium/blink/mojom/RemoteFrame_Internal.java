...
class RemoteFrame_Internal {
    ...
    private static final int SET_REPLICATED_AD_FRAME_TYPE_ORDINAL = 5;

    private static final int DISPATCH_LOAD_EVENT_FOR_FRAME_OWNER_ORDINAL = 6;

    private static final int SET_NEEDS_OCCLUSION_TRACKING_ORDINAL = 7;

    private static final int COLLAPSE_ORDINAL = 8;

    private static final int FOCUS_ORDINAL = 9;

    private static final int SET_HAD_STICKY_USER_ACTIVATION_BEFORE_NAVIGATION_ORDINAL = 10;

    private static final int BUBBLE_LOGICAL_SCROLL_ORDINAL = 11;

    private static final int UPDATE_USER_ACTIVATION_STATE_ORDINAL = 12;

    private static final int SET_EMBEDDING_TOKEN_ORDINAL = 13;

    private static final int SET_PAGE_FOCUS_ORDINAL = 14;

    private static final int RENDER_FALLBACK_CONTENT_ORDINAL = 15;

    private static final int ADD_RESOURCE_TIMING_FROM_CHILD_ORDINAL = 16;

    private static final int SCROLL_RECT_TO_VISIBLE_ORDINAL = 17;

    private static final int DID_START_LOADING_ORDINAL = 18;

    private static final int DID_STOP_LOADING_ORDINAL = 19;

    private static final int INTRINSIC_SIZING_INFO_OF_CHILD_CHANGED_ORDINAL = 20;
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case UPDATE_USER_ACTIVATION_STATE_ORDINAL: {
                        ...
                        getImpl().updateUserActivationState(data.stateUpdateType);
                        return true;
                    }
