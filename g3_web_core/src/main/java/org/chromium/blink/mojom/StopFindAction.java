...
public final class StopFindAction {
    ...
    public static final int STOP_FIND_ACTION_KEEP_SELECTION = 1; // STOP_FIND_ACTION_CLEAR_SELECTION + 1
    public static final int STOP_FIND_ACTION_ACTIVATE_SELECTION = 2; // STOP_FIND_ACTION_KEEP_SELECTION + 1
