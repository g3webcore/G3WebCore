...
public final class PermissionDescriptorExtension extends org.chromium.mojo.bindings.Union {
    ...
    public void setWakeLock(WakeLockPermissionDescriptor wakeLock) {
        this.mTag = Tag.WakeLock;
        this.mWakeLock = wakeLock;
    }

    public WakeLockPermissionDescriptor getWakeLock() {
        assert this.mTag == Tag.WakeLock;
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder0, int offset) {
        ...
        switch (mTag) {
            ...
            case Tag.WakeLock: {
                ...
                encoder0.encode(this.mWakeLock, offset + 8, false);
                break;
            }
            default: {
                break;
    ...
    public static final PermissionDescriptorExtension decode(org.chromium.mojo.bindings.Decoder decoder0, int offset) {
        ...
        switch (dataHeader.elementsOrVersion) {
            ...
            case Tag.WakeLock: {
                ...
                org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(offset + org.chromium.mojo.bindings.DataHeader.HEADER_SIZE, false);
                result.mWakeLock = WakeLockPermissionDescriptor.decode(decoder1);
                result.mTag = Tag.WakeLock;
                break;
            }
            default: {
                break;
