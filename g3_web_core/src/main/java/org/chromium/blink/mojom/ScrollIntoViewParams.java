...
public final class ScrollIntoViewParams extends org.chromium.mojo.bindings.Struct {
    ...
    public static final class Type {
        ...
        public static final int PROGRAMMATIC = 1; // USER + 1
        public static final int CLAMPING = 2; // PROGRAMMATIC + 1
        public static final int COMPOSITOR = 3; // CLAMPING + 1
        public static final int ANCHORING = 4; // COMPOSITOR + 1
        public static final int SEQUENCED = 5; // ANCHORING + 1
    ...
    public static final class Behavior {
        ...
        public static final int INSTANT = 1; // AUTO + 1
        public static final int SMOOTH = 2; // INSTANT + 1
    ...
    private ScrollIntoViewParams(int version) {
        ...
        this.type = (int) ScrollIntoViewParams.Type.PROGRAMMATIC;
        this.makeVisibleInVisualViewport = (boolean) true;
        this.behavior = (int) ScrollIntoViewParams.Behavior.AUTO;
        ...
        try {
            ...
            result = new ScrollIntoViewParams(elementsOrVersion);
                ...
                result.type = decoder0.readInt(24);
                    ScrollIntoViewParams.Type.validate(result.type);
                }
                {
                ...
                result.behavior = decoder0.readInt(32);
                    ScrollIntoViewParams.Behavior.validate(result.behavior);
                }
                {
