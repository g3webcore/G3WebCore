...
class PeerConnectionManager_Internal {
    ...
    private static final int START_EVENT_LOG_ORDINAL = 1;

    private static final int STOP_EVENT_LOG_ORDINAL = 2;

    private static final int GET_STANDARD_STATS_ORDINAL = 3;

    private static final int GET_LEGACY_STATS_ORDINAL = 4;
