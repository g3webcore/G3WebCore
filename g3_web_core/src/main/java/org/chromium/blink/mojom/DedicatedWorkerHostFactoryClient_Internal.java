...
ServiceWorkerProviderInfoForClient serviceWorkerProviderInfo, WorkerMainScriptLoadParams mainScriptLoadParams, UrlLoaderFactoryBundle subresourceLoaderFactories, org.chromium.mojo.bindings.InterfaceRequest<SubresourceLoaderUpdater> subresourceLoaderUpdater, ControllerServiceWorkerInfo controllerInfo) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case ON_SCRIPT_LOAD_STARTED_ORDINAL: {
                        ...
                        getImpl().onScriptLoadStarted(data.serviceWorkerProviderInfo, data.mainScriptLoadParams, data.subresourceLoaderFactories, data.subresourceLoaderUpdater, data.controllerInfo);
                        return true;
                    }
