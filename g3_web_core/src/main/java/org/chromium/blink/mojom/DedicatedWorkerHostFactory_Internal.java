...
org.chromium.mojo.bindings.InterfaceRequest<BrowserInterfaceBroker> browserInterfaceBroker, org.chromium.mojo.bindings.InterfaceRequest<DedicatedWorkerHost> host) {
...
org.chromium.url.mojom.Url scriptUrl, int credentialsMode, FetchClientSettingsObject outsideFetchClientSettingsObject, BlobUrlToken blobUrlToken, DedicatedWorkerHostFactoryClient client, org.chromium.mojo.bindings.InterfaceRequest<DedicatedWorkerHost> host) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case CREATE_WORKER_HOST_ORDINAL: {
                        ...
                        getImpl().createWorkerHost(data.browserInterfaceBroker, data.host);
                        return true;
                    }
                    ...
                    case CREATE_WORKER_HOST_AND_START_SCRIPT_LOAD_ORDINAL: {
                        ...
                        getImpl().createWorkerHostAndStartScriptLoad(data.scriptUrl, data.credentialsMode, data.outsideFetchClientSettingsObject, data.blobUrlToken, data.client, data.host);
                        return true;
                    }
    ...
    static final class DedicatedWorkerHostFactoryCreateWorkerHostParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static DedicatedWorkerHostFactoryCreateWorkerHostParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new DedicatedWorkerHostFactoryCreateWorkerHostParams(elementsOrVersion);
                    ...
                    result.browserInterfaceBroker = decoder0.readInterfaceRequest(8, false);
                    }
                    {
                        
                    result.host = decoder0.readInterfaceRequest(12, false);
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.browserInterfaceBroker, 8, false);
            
            encoder0.encode(this.host, 12, false);
        }
    }
    ...
    static final class DedicatedWorkerHostFactoryCreateWorkerHostAndStartScriptLoadParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static DedicatedWorkerHostFactoryCreateWorkerHostAndStartScriptLoadParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new DedicatedWorkerHostFactoryCreateWorkerHostAndStartScriptLoadParams(elementsOrVersion);
                    ...
                    result.credentialsMode = decoder0.readInt(16);
                    ...
                    result.client = decoder0.readServiceInterface(40, false, DedicatedWorkerHostFactoryClient.MANAGER);
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.credentialsMode, 16);
            ...
            encoder0.encode(this.client, 40, false, DedicatedWorkerHostFactoryClient.MANAGER);
        }
    }
