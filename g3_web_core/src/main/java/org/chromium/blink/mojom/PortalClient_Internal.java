...
TransferableMessage message, org.chromium.url.internal.mojom.Origin sourceOrigin, org.chromium.url.internal.mojom.Origin targetOrigin) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case FORWARD_MESSAGE_FROM_GUEST_ORDINAL: {
                        ...
                        getImpl().forwardMessageFromGuest(data.message, data.sourceOrigin, data.targetOrigin);
                        return true;
                    }
    ...
    static final class PortalClientForwardMessageFromGuestParams extends org.chromium.mojo.bindings.Struct {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.targetOrigin, 24, true);
        }
    }
