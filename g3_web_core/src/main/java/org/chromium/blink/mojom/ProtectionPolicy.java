...
public final class ProtectionPolicy {
    ...
    public static final int NONE = 1; // UNSPECIFIED + 1
    public static final int UV_OR_CRED_ID_REQUIRED = 2; // NONE + 1
    public static final int UV_REQUIRED = 3; // UV_OR_CRED_ID_REQUIRED + 1
