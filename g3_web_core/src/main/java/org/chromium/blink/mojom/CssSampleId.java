...
public final class CssSampleId {
    ...
    public static final int INTERNAL_UA_BACKGROUND_ATTACHMENT = 0;
    public static final int INTERNAL_UA_BACKGROUND_BLEND_MODE = 0;
    public static final int INTERNAL_UA_BACKGROUND_CLIP = 0;
    public static final int INTERNAL_UA_BACKGROUND_COLOR = 0;
    public static final int INTERNAL_UA_BACKGROUND_IMAGE = 0;
    public static final int INTERNAL_UA_BACKGROUND_ORIGIN = 0;
    public static final int INTERNAL_UA_BACKGROUND_POSITION_X = 0;
    public static final int INTERNAL_UA_BACKGROUND_POSITION_Y = 0;
    public static final int INTERNAL_UA_BACKGROUND_SIZE = 0;
    public static final int INTERNAL_UA_BORDER_BOTTOM_COLOR = 0;
    public static final int INTERNAL_UA_BORDER_BOTTOM_LEFT_RADIUS = 0;
    public static final int INTERNAL_UA_BORDER_BOTTOM_RIGHT_RADIUS = 0;
    public static final int INTERNAL_UA_BORDER_BOTTOM_STYLE = 0;
    public static final int INTERNAL_UA_BORDER_BOTTOM_WIDTH = 0;
    public static final int INTERNAL_UA_BORDER_IMAGE_OUTSET = 0;
    public static final int INTERNAL_UA_BORDER_IMAGE_REPEAT = 0;
    public static final int INTERNAL_UA_BORDER_IMAGE_SLICE = 0;
    public static final int INTERNAL_UA_BORDER_IMAGE_SOURCE = 0;
    public static final int INTERNAL_UA_BORDER_IMAGE_WIDTH = 0;
    public static final int INTERNAL_UA_BORDER_LEFT_COLOR = 0;
    public static final int INTERNAL_UA_BORDER_LEFT_STYLE = 0;
    public static final int INTERNAL_UA_BORDER_LEFT_WIDTH = 0;
    public static final int INTERNAL_UA_BORDER_RIGHT_COLOR = 0;
    public static final int INTERNAL_UA_BORDER_RIGHT_STYLE = 0;
    public static final int INTERNAL_UA_BORDER_RIGHT_WIDTH = 0;
    public static final int INTERNAL_UA_BORDER_TOP_COLOR = 0;
    public static final int INTERNAL_UA_BORDER_TOP_LEFT_RADIUS = 0;
    public static final int INTERNAL_UA_BORDER_TOP_RIGHT_RADIUS = 0;
    public static final int INTERNAL_UA_BORDER_TOP_STYLE = 0;
    public static final int INTERNAL_UA_BORDER_TOP_WIDTH = 0;
