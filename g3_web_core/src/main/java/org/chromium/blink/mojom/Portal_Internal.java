...
TransferableMessage message, org.chromium.url.internal.mojom.Origin targetOrigin) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case POST_MESSAGE_TO_GUEST_ORDINAL: {
                        ...
                        getImpl().postMessageToGuest(data.message, data.targetOrigin);
                        return true;
                    }
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case ACTIVATE_ORDINAL: {
                        ...
                        getImpl().activate(data.data, new PortalActivateResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class PortalPostMessageToGuestParams extends org.chromium.mojo.bindings.Struct {
        ...
        public org.chromium.url.internal.mojom.Origin targetOrigin;
        ...
        public static PortalPostMessageToGuestParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new PortalPostMessageToGuestParams(elementsOrVersion);
                    ...
                    result.targetOrigin = org.chromium.url.internal.mojom.Origin.decode(decoder1);
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.targetOrigin, 16, true);
        }
    }
