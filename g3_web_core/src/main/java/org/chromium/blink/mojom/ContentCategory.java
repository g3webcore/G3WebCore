...
public final class ContentCategory {
    ...
    public static final int HOME_PAGE = 1; // NONE + 1
    public static final int ARTICLE = 2; // HOME_PAGE + 1
    public static final int VIDEO = 3; // ARTICLE + 1
    public static final int AUDIO = 4; // VIDEO + 1
