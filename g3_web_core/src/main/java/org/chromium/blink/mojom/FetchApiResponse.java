...
public final class FetchApiResponse extends org.chromium.mojo.bindings.Struct {
    ...
    public static FetchApiResponse decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new FetchApiResponse(elementsOrVersion);
                ...
                {
                    org.chromium.mojo.bindings.DataHeader si1 = decoder1.readDataHeaderForPointerArray(org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                    result.contentSecurityPolicy = new org.chromium.network.mojom.ContentSecurityPolicy[si1.elementsOrVersion];
                    for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {
                        
                        org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i1, false);
                        result.contentSecurityPolicy[i1] = org.chromium.network.mojom.ContentSecurityPolicy.decode(decoder2);
                    }
                }
                }
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        if (this.contentSecurityPolicy == null) {
            ...
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.contentSecurityPolicy.length, 96, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
