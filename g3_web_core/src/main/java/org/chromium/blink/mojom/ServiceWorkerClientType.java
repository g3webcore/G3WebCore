...
public final class ServiceWorkerClientType {
    ...
    public static final int DEDICATED_WORKER = 1; // WINDOW + 1
    public static final int SHARED_WORKER = 2; // DEDICATED_WORKER + 1
    public static final int ALL = 3; // SHARED_WORKER + 1
