...
class ClipboardHost_Internal {
    ...
    private static final int READ_AVAILABLE_PLATFORM_SPECIFIC_FORMAT_NAMES_ORDINAL = 3;

    private static final int READ_TEXT_ORDINAL = 4;

    private static final int READ_HTML_ORDINAL = 5;
    ...
    private static final int WRITE_SMART_PASTE_MARKER_ORDINAL = 11;

    private static final int WRITE_CUSTOM_DATA_ORDINAL = 12;

    private static final int WRITE_RAW_DATA_ORDINAL = 13;
...
ReadAvailableTypesResponse callback) {
        ...
        @Override
        public void readAvailablePlatformSpecificFormatNames(
int buffer, 
ReadAvailablePlatformSpecificFormatNamesResponse callback) {

            ClipboardHostReadAvailablePlatformSpecificFormatNamesParams _message = new ClipboardHostReadAvailablePlatformSpecificFormatNamesParams();
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(
                                    READ_AVAILABLE_PLATFORM_SPECIFIC_FORMAT_NAMES_ORDINAL,
                                    org.chromium.mojo.bindings.MessageHeader.MESSAGE_EXPECTS_RESPONSE_FLAG,
                                    0)),
                    new ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParamsForwardToCallback(callback));
...
org.chromium.skia.mojom.Bitmap image) {
        ...
        public boolean acceptWithResponder(org.chromium.mojo.bindings.Message message, org.chromium.mojo.bindings.MessageReceiver receiver) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case READ_AVAILABLE_PLATFORM_SPECIFIC_FORMAT_NAMES_ORDINAL: {

                        ClipboardHostReadAvailablePlatformSpecificFormatNamesParams data =
                                ClipboardHostReadAvailablePlatformSpecificFormatNamesParams.deserialize(messageWithHeader.getPayload());

                        getImpl().readAvailablePlatformSpecificFormatNames(data.buffer, new ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class ClipboardHostReadAvailablePlatformSpecificFormatNamesParams extends org.chromium.mojo.bindings.Struct {
        ...
        private ClipboardHostReadAvailablePlatformSpecificFormatNamesParams(int version) {
            super(STRUCT_SIZE, version);
        }

        public ClipboardHostReadAvailablePlatformSpecificFormatNamesParams() {
            this(0);
        }

        public static ClipboardHostReadAvailablePlatformSpecificFormatNamesParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static ClipboardHostReadAvailablePlatformSpecificFormatNamesParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static ClipboardHostReadAvailablePlatformSpecificFormatNamesParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ClipboardHostReadAvailablePlatformSpecificFormatNamesParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new ClipboardHostReadAvailablePlatformSpecificFormatNamesParams(elementsOrVersion);
                    {
    ...
    static final class ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParams(int version) {
            super(STRUCT_SIZE, version);
        }

        public ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParams() {
            this(0);
        }

        public static ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParams(elementsOrVersion);
                    {
    ...
    static class ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
            implements org.chromium.mojo.bindings.MessageReceiver {
        private final ClipboardHost.ReadAvailablePlatformSpecificFormatNamesResponse mCallback;

        ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParamsForwardToCallback(ClipboardHost.ReadAvailablePlatformSpecificFormatNamesResponse callback) {
            this.mCallback = callback;
        }
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                org.chromium.mojo.bindings.ServiceMessage messageWithHeader =
                        message.asServiceMessage();
                org.chromium.mojo.bindings.MessageHeader header = messageWithHeader.getHeader();
                if (!header.validateHeader(READ_AVAILABLE_PLATFORM_SPECIFIC_FORMAT_NAMES_ORDINAL,
                                           org.chromium.mojo.bindings.MessageHeader.MESSAGE_IS_RESPONSE_FLAG)) {
                    return false;
                }

                ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParams response = ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParams.deserialize(messageWithHeader.getPayload());
    ...
    static class ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParamsProxyToResponder implements ClipboardHost.ReadAvailablePlatformSpecificFormatNamesResponse {

        private final org.chromium.mojo.system.Core mCore;
        private final org.chromium.mojo.bindings.MessageReceiver mMessageReceiver;
        private final long mRequestId;

        ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParamsProxyToResponder(
                org.chromium.mojo.system.Core core,
                org.chromium.mojo.bindings.MessageReceiver messageReceiver,
                long requestId) {
            mCore = core;
        ...
        public void call(org.chromium.mojo_base.mojom.String16[] rawTypes) {
            ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParams _response = new ClipboardHostReadAvailablePlatformSpecificFormatNamesResponseParams();
