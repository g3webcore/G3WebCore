...
public final class ResourceTimingInfo extends org.chromium.mojo.bindings.Struct {
    ...
    public static ResourceTimingInfo decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new ResourceTimingInfo(elementsOrVersion);
                ...
                result.isSecureContext = decoder0.readBoolean(68, 1);
                }
                {
                ...
                result.allowRedirectDetails = decoder0.readBoolean(68, 3);
                }
                {
                    
                result.allowNegativeValues = decoder0.readBoolean(68, 4);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.isSecureContext, 68, 1);
        
        encoder0.encode(this.allowTimingDetails, 68, 2);
        
        encoder0.encode(this.allowRedirectDetails, 68, 3);
        
        encoder0.encode(this.allowNegativeValues, 68, 4);
