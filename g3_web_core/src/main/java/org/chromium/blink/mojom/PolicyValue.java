...
public final class PolicyValue extends org.chromium.mojo.bindings.Struct {
     ...
     */
    public static PolicyValue deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static PolicyValue decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            result = new PolicyValue(elementsOrVersion);
                {
