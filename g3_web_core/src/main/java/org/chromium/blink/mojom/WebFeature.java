...
public final class WebFeature {
    ...
    public static final int HTML_IMPORTS_HAS_STYLE_SHEETS_OBSOLETE = 940;
    ...
    public static final int INPUT_TYPE_CHECKBOX_RENDERED_NON_SQUARE = 3121;
    public static final int INPUT_TYPE_RADIO_RENDERED_NON_SQUARE = 3122;
    ...
    public static final int NUMBER_OF_FEATURES = 3158; // CSS_COMPARISON_FUNCTIONS + 1
