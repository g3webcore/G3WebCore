...
EmbeddedWorkerStartParams params) {
        ...
        public void resumeAfterDownload(
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(RESUME_AFTER_DOWNLOAD_ORDINAL)));
    ...
    static final class EmbeddedWorkerInstanceClientResumeAfterDownloadParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static EmbeddedWorkerInstanceClientResumeAfterDownloadParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static EmbeddedWorkerInstanceClientResumeAfterDownloadParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
