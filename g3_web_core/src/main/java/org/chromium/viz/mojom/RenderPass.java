// RenderPass.java is auto generated by mojom_bindings_generator.py, do not edit
...
// For:
//     services/viz/public/mojom/compositing/render_pass.mojom
//
...
public final class RenderPass extends org.chromium.mojo.bindings.Struct {
    ...
    public static RenderPass deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static RenderPass decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
