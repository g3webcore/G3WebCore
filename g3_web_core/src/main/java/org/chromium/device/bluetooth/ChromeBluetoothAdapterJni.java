...
final class ChromeBluetoothAdapterJni implements ChromeBluetoothAdapter.Natives {
  ...
  public void createOrUpdateDeviceOnScan(long nativeBluetoothAdapterAndroid,
    ...
    GEN_JNI.org_chromium_device_bluetooth_ChromeBluetoothAdapter_createOrUpdateDeviceOnScan(nativeBluetoothAdapterAndroid, caller, address, deviceWrapper, localName, rssi, advertisedUuids, txPower, serviceDataKeys, serviceDataValues, manufacturerDataKeys, manufacturerDataValues);
  }
