...
public final class DnsConfigOverrides extends org.chromium.mojo.bindings.Struct {
    ...
    public static DnsConfigOverrides decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new DnsConfigOverrides(elementsOrVersion);
                ...
                result.allowDnsOverHttpsUpgrade = decoder0.readInt(76);
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.allowDnsOverHttpsUpgrade, 76);
        
        if (this.disabledUpgradeProviders == null) {
            encoder0.encodeNullPointer(80, true);
        } else {
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.disabledUpgradeProviders.length, 80, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
