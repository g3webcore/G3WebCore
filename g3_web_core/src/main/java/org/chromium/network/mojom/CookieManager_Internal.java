...
CanonicalCookie cookie, String sourceScheme, CookieOptions cookieOptions, 
...
org.chromium.content_settings.mojom.ContentSettingPatternSource[] settings) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case SET_CANONICAL_COOKIE_ORDINAL: {
                        ...
                        getImpl().setCanonicalCookie(data.cookie, data.sourceScheme, data.cookieOptions, new CookieManagerSetCanonicalCookieResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class CookieManagerGetCookieListResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(24, 0)};
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public CookieWithStatus[] cookies;
        ...
        public static CookieManagerGetCookieListResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new CookieManagerGetCookieListResponseParams(elementsOrVersion);
                    ...
                    {
                        org.chromium.mojo.bindings.DataHeader si1 = decoder1.readDataHeaderForPointerArray(org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                        result.cookies = new CookieWithStatus[si1.elementsOrVersion];
                        for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {
                            
                            org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i1, false);
                            result.cookies[i1] = CookieWithStatus.decode(decoder2);
                        }
                    }
                    }
                    {
                    ...
                    {
                        org.chromium.mojo.bindings.DataHeader si1 = decoder1.readDataHeaderForPointerArray(org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                        result.excludedCookies = new CookieWithStatus[si1.elementsOrVersion];
                        for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {
                            
                            org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i1, false);
                            result.excludedCookies[i1] = CookieWithStatus.decode(decoder2);
                        }
                    }
                    }
    ...
    static class CookieManagerGetCookieListResponseParamsProxyToResponder implements CookieManager.GetCookieListResponse {
        ...
        @Override
        public void call(CookieWithStatus[] cookies, CookieWithStatus[] excludedCookies) {
    ...
    static class CookieManagerSetCanonicalCookieResponseParamsProxyToResponder implements CookieManager.SetCanonicalCookieResponse {
        ...
        @Override
        public void call(CookieInclusionStatus status) {
