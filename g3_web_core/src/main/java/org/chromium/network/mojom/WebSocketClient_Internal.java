...
boolean fin, int type, long dataLength) {
        ...
        @Override
        public void addSendFlowControlQuota(
long quota) {
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(ADD_SEND_FLOW_CONTROL_QUOTA_ORDINAL)));
...
boolean wasClean, short code, String reason) {
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case ADD_SEND_FLOW_CONTROL_QUOTA_ORDINAL: {

                        WebSocketClientAddSendFlowControlQuotaParams data =
                                WebSocketClientAddSendFlowControlQuotaParams.deserialize(messageWithHeader.getPayload());

                        getImpl().addSendFlowControlQuota(data.quota);
                        return true;
                    }
    ...
    static final class WebSocketClientAddSendFlowControlQuotaParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static WebSocketClientAddSendFlowControlQuotaParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static WebSocketClientAddSendFlowControlQuotaParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static WebSocketClientAddSendFlowControlQuotaParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            WebSocketClientAddSendFlowControlQuotaParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new WebSocketClientAddSendFlowControlQuotaParams(elementsOrVersion);
                    {
