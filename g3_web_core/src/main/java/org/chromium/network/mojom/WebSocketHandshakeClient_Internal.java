...
class WebSocketHandshakeClient_Internal {
    ...
    private static final int ON_CONNECTION_ESTABLISHED_ORDINAL = 1;
...
WebSocket socket, org.chromium.mojo.bindings.InterfaceRequest<WebSocketClient> clientReceiver, WebSocketHandshakeResponse response, org.chromium.mojo.system.DataPipe.ConsumerHandle readable) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case ON_CONNECTION_ESTABLISHED_ORDINAL: {
                        ...
                        getImpl().onConnectionEstablished(data.socket, data.clientReceiver, data.response, data.readable);
                        return true;
                    }
