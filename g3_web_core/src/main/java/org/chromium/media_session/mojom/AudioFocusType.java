...
public final class AudioFocusType {
    ...
    public static final int GAIN_TRANSIENT_MAY_DUCK = 1; // GAIN + 1
    public static final int GAIN_TRANSIENT = 2; // GAIN_TRANSIENT_MAY_DUCK + 1
    public static final int AMBIENT = 3; // GAIN_TRANSIENT + 1
