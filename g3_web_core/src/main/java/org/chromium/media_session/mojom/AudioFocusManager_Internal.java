...
org.chromium.mojo_base.mojom.UnguessableToken requestId, org.chromium.mojo.bindings.InterfaceRequest<AudioFocusRequestClient> client, MediaSession mediaSession, MediaSessionInfo sessionInfo, int type, org.chromium.mojo_base.mojom.UnguessableToken groupId, 
...
GetSourceFocusRequestsResponse callback) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case REQUEST_GROUPED_AUDIO_FOCUS_ORDINAL: {
                        ...
                        getImpl().requestGroupedAudioFocus(data.requestId, data.client, data.mediaSession, data.sessionInfo, data.type, data.groupId, new AudioFocusManagerRequestGroupedAudioFocusResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class AudioFocusManagerRequestGroupedAudioFocusParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static AudioFocusManagerRequestGroupedAudioFocusParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new AudioFocusManagerRequestGroupedAudioFocusParams(elementsOrVersion);
                    ...
                    result.mediaSession = decoder0.readServiceInterface(20, false, MediaSession.MANAGER);
                    }
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.mediaSession, 20, false, MediaSession.MANAGER);
