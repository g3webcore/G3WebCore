...
class MediaMetricsProvider_Internal {
    ...
    private static final int SET_HAS_AUDIO_ORDINAL = 12;

    private static final int SET_HAS_VIDEO_ORDINAL = 13;

    private static final int SET_VIDEO_PIPELINE_INFO_ORDINAL = 14;

    private static final int SET_AUDIO_PIPELINE_INFO_ORDINAL = 15;
