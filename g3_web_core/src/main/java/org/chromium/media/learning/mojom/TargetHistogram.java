...
public final class TargetHistogram extends org.chromium.mojo.bindings.Struct {
    ...
    public java.util.Map<TargetValue, Double> counts;
                ...
                org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(8, false);
                {
                    ...
                    double[] values0;
                    {
                        ...
                        org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE, false);
                        {
                            ...
                            keys0 = new TargetValue[si2.elementsOrVersion];
                            for (int i2 = 0; i2 < si2.elementsOrVersion; ++i2) {
                                ...
                                keys0[i2] = TargetValue.decode(decoder3);
                            }
                        }
                    }
                    {
                    ...
                    result.counts = new java.util.HashMap<TargetValue, Double>();
                    for (int index0 = 0; index0 < keys0.length; ++index0) {
                        result.counts.put(keys0[index0],  values0[index0]);
                    }
                }
                }
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        if (this.counts == null) {
            ...
            int size0 = this.counts.size();
            TargetValue[] keys0 = new TargetValue[size0];
            double[] values0 = new double[size0];
            int index0 = 0;
            for (java.util.Map.Entry<TargetValue, Double> entry0 : this.counts.entrySet()) {
