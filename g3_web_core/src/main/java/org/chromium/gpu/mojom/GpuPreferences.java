...
public final class GpuPreferences extends org.chromium.mojo.bindings.Struct {
    ...
    public static GpuPreferences decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new GpuPreferences(elementsOrVersion);
                ...
                result.enforceVulkanProtectedMemory = decoder0.readBoolean(28, 3);
                }
                {
                    
                result.disableVulkanSurface = decoder0.readBoolean(28, 4);
                }
                {
                    
                result.disableVulkanFallbackToGlForTesting = decoder0.readBoolean(28, 5);
                }
                {
                    
                result.enableMetal = decoder0.readBoolean(28, 6);
                }
                {
                ...
                result.enableGpuBlockedTimeMetric = decoder0.readBoolean(29, 1);
                }
                {
                    
                result.enableNativeGpuMemoryBuffers = decoder0.readBoolean(29, 2);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.enforceVulkanProtectedMemory, 28, 3);
        
        encoder0.encode(this.disableVulkanSurface, 28, 4);
        
        encoder0.encode(this.disableVulkanFallbackToGlForTesting, 28, 5);
        
        encoder0.encode(this.enableMetal, 28, 6);
        
        encoder0.encode(this.enableGpuBenchmarkingExtension, 28, 7);
        
        encoder0.encode(this.enableWebgpu, 29, 0);
        
        encoder0.encode(this.enableGpuBlockedTimeMetric, 29, 1);
        
        encoder0.encode(this.enableNativeGpuMemoryBuffers, 29, 2);
