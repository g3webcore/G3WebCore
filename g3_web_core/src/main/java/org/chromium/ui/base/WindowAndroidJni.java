...
final class WindowAndroidJni implements WindowAndroid.Natives {
  ...
  public void onCursorVisibilityChanged(long nativeWindowAndroid, WindowAndroid caller,
      boolean visible) {
    GEN_JNI.org_chromium_ui_base_WindowAndroid_onCursorVisibilityChanged(nativeWindowAndroid, caller, visible);
  }

  @Override
  public void onFallbackCursorModeToggled(long nativeWindowAndroid, WindowAndroid caller,
      boolean isOn) {
    GEN_JNI.org_chromium_ui_base_WindowAndroid_onFallbackCursorModeToggled(nativeWindowAndroid, caller, isOn);
  }
