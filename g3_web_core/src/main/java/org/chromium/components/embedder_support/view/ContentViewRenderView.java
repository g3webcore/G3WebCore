...
public class ContentViewRenderView extends FrameLayout {
    ...
    private class SurfaceData implements SurfaceEventListener {
        ...
        public SurfaceData(int mode, FrameLayout parent, SurfaceEventListener listener,
    ...
    private class TextureViewSurfaceTextureListener
...
//            Canvas canvas = mCurrentSurface.lockCanvas(null);
...
//            mCurrentSurface.unlockCanvasAndPost(canvas);
     ...
     */
    public void onNativeLibraryLoaded(WindowAndroid rootWindow, int mode) {
    ...
    public void requestMode(int mode, ValueCallback<Boolean> callback) {
