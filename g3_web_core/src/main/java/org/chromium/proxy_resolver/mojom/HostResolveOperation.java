...
public final class HostResolveOperation {
    ...
    public static final int DNS_RESOLVE_EX = 1; // DNS_RESOLVE + 1
    public static final int MY_IP_ADDRESS = 2; // DNS_RESOLVE_EX + 1
    public static final int MY_IP_ADDRESS_EX = 3; // MY_IP_ADDRESS + 1
