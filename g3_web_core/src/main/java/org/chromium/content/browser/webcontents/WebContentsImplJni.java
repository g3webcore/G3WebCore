...
final class WebContentsImplJni implements WebContentsImpl.Natives {
  ...
  public String getVisibleURL(long nativeWebContentsAndroid, WebContentsImpl caller) {
    return (String)GEN_JNI.org_chromium_content_browser_webcontents_WebContentsImpl_getVisibleURL(nativeWebContentsAndroid, caller);
  }
  ...
  public boolean isShowingInterstitialPage(long nativeWebContentsAndroid, WebContentsImpl caller) {
    return (boolean)GEN_JNI.org_chromium_content_browser_webcontents_WebContentsImpl_isShowingInterstitialPage(nativeWebContentsAndroid, caller);
  }
