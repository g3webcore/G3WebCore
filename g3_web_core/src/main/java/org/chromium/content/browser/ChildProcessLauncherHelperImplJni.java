...
final class ChildProcessLauncherHelperImplJni implements ChildProcessLauncherHelperImpl.Natives {
  ...
  public void setTerminationInfo(long termiantionInfoPtr, int bindingState, boolean killedByUs,
      ...
      int reverseRank) {
    GEN_JNI.org_chromium_content_browser_ChildProcessLauncherHelperImpl_setTerminationInfo(termiantionInfoPtr, bindingState, killedByUs, cleanExit, remainingStrong, remainingModerate, remainingWaived, reverseRank);
  }
