...
final class WebContentsAccessibilityImplJni implements WebContentsAccessibilityImpl.Natives {
  ...
  public boolean scroll(long nativeWebContentsAccessibilityAndroid,
    ...
    return (boolean)GEN_JNI.org_chromium_content_browser_accessibility_WebContentsAccessibilityImpl_scroll(nativeWebContentsAccessibilityAndroid, caller, id, direction);
  }
